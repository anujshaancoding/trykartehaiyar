...
function ShareButtons({ title, excerpt, url, coverImage, language }) {
  ...
  return (
    <div className="share-section">
      <h3 className="share-title">
        {language === 'hi' ? 'इसे साझा करें' : 'Share this article'}
      </h3>
      ...
      <div className="share-buttons">
        ...
        {navigator.share && (
          ...
          >
            ...
            <span>{language === 'hi' ? 'और विकल्प' : 'More'}</span>
          </button>
        )}
      </div>
      ...
      {showToast && (
        <div className="share-toast">
          {language === 'hi' ? 'लिंक कॉपी हो गया!' : 'Link copied to clipboard!'}
        </div>
      )}
    </div>
  )
